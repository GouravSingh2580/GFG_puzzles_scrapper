...
.then(function(){
    ...
    let IPKitPromise=pageNavigation("#topics > section > div.dashboard-section-grid > div > div > ul > li:nth-child(1) > a > div > div");
    // let warmupChallengesPromise=pageNavigation('a[data-attr1="warmup"]');
    return IPKitPromise;
})
.then(function(){
    // console.log("ipk is clicked");
    let warmupPromise=pageNavigation('#contest-challenges-problem > div > div > div.cta-container > div > div > button > div > span');
